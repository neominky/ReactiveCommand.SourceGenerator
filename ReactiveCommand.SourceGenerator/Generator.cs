...
using ReactiveCommandSourceGenerator.Attributes;
...
public class Generator : ISourceGenerator
{
    ...
    {
        AddReactiveCommandAttributeClass(context); //tricky!
    ...
    private void AddReactiveCommandAttributeClass(GeneratorExecutionContext context)
    {
        //https://github.com/SparkyTD/ReactiveCommand.SourceGenerator/issues/1
        //Add the ReactiveCommand Attribute class to user code.
        //This bypasses using the ReactiveUI.ReactiveCommand static class.
        context.AddSource($"ReactiveCommandAttribute.g.cs",
@"// <auto-generated>
using System;
